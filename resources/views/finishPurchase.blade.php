...
<div class="container">
    ...
    <div class="container">
        <div>
            ...
            <li class="d-inline" style="margin-left: 262px;">Código de cuenta</li>
            </div>
            <div class="d-inline d-flex w-100" style="margin-left: 310px;">
                ...
                <input class="form-control d-inline" style="margin-left: 54px;  width: 320px;" type="text" placeholder="Ingrese su código"/>
            </div>
        </div>
        <br>
        <div>
