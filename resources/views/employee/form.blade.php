...
<div class="form-group">
    ...
    <input type="text" name="email" id="email" value="{{ isset($employeeData->email)?$employeeData->email:old('email') }}" class="form-control">
    ...
    <input type="text" name="password" id="password" value="{{ isset($employeeData->password)?$employeeData->password:old('password') }}" class="form-control">
