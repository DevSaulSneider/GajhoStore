        ...
        <div class="w-50 pe-2">
            <form method="GET" action="{{ route('category.consultarCategoriaPorID') }}">
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="d-flex">
                        <input type="text" class="form-control shadow-none" id="consultaID" name="consultaID"
                            placeholder="Consultar por ID de categoria">
        ...
        <div class="w-50 ps-2">
            <form method="GET" action="{{ route('category.index') }}">
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="d-flex">
                        <input type="text" class="form-control shadow-none" id="filtrarNombre" name="filtrarNombre"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="w-25">
                        <form action="{{ url('/category/'.$category->id)}}" method="post" class="d-inline">
                            <a href="{{ url('/category/'.$category->id.'/edit') }}"
                                class="btn btn-sm btn-success rounded-pill"><i class="fa fa-fw fa-edit"></i> Editar</a>
                            @csrf
                            {{ method_field('DELETE') }}
                            <button type="submit" class="btn btn-danger btn-sm rounded-pill"><i
                                    class="fa fa-fw fa-trash"></i> Borrar</button>
